...
int mlx_mouse_hook_pre (void *win, int (*funct)(), void *param);
int mlx_mouse_hook_rel (void *win, int (*funct)(), void *param);
int mlx_mouse_hook_mov (void *win, int (*funct)(), void *param);
